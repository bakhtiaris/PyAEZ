...
class TestBioMassCalc(unittest.TestCase):
    ...
    def test_calculateBiomassNumba_constant(self):
        ...
        max_reasonable_biomass = 50000  # Based on realistic agronomic limits from literature
        self.assertLess(bn, max_reasonable_biomass) # And within reasonable bounds
    ...
    def test_calculateBiomassNumbaIntermediates(self):
        ...
        # Bn , Ac_mean, bc_mean, bo_mean, meanT_mean, dT_mean, Rg, f_day_clouded, iPm, Ct, l, bgm, Bn, Ac_interp, Bc_interp, Bo_interp
